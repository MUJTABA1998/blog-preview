...
import Quote from "../ModuleComponents/Quote";
import Paragraph from "../ModuleComponents/Paragraph";
import Heading from "../ModuleComponents/Heading";
import Code from "../ModuleComponents/Code";
import Image from "../ModuleComponents/Image";
import List from "../ModuleComponents/List";
import LinkTag from "../ModuleComponents/Link";
  ...
  function sortContentByType(content) {
    switch (content.type) {
      ...
      case "code":
        ...
        return (
          <div className="max-w-2xl min-h-[130px] h-full pt-7 px-5 mb-4 bg-gray-600 rounded-[4px] text-xs text-white  ">
            {code.map((c, index) => (
            ...
            <div className="flex flex-col items-start justify-start gap-1">
              <div className="flex flex-wrap items-center justify-between w-full gap-6 px-2">
                ...
                <div className="flex items-start justify-start gap-4 ml-16 sm:ml-0">
                  <Link to="/" className="text-xs text-gray-700 sm:text-sm">
                    <ImTwitter />
                  </Link>
                  <Link to="/" className="text-xs text-gray-700 sm:text-sm">
                    <ImFacebook2 />
